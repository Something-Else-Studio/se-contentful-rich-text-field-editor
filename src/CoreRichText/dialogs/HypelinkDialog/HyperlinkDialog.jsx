...
export class HyperlinkDialog extends React.Component {
  ...
  renderFields() {
    ...
    const isUriInputAutoFocused =
      type === LINK_TYPES.URI && (hideText || !!text);
        ...
        {isFeaturingEntitySelector(entitySelectorConfigs) && (
          <FormControl id="link-type" name="link-type">
            ...
            >
              ...
              {allowedHyperlinkTypes.includes(LINK_TYPES.URI) ||
              type === LINK_TYPES.URI ? (
                <Select.Option value={LINK_TYPES.URI}>URL</Select.Option>
              ) : null}
              {allowedHyperlinkTypes.includes(LINK_TYPES.ENTRY) ||
              type === LINK_TYPES.ENTRY ? (
                <Select.Option value={LINK_TYPES.ENTRY}>Entry</Select.Option>
              ) : null}
              {allowedHyperlinkTypes.includes(LINK_TYPES.ASSET) ||
  ...
  renderEntityField() {
    ...
    return (
      <div>
        ...
        {isEntitySelectorVisible &&
          this.renderEntitySelector(type, isEntitySelectorVisible)}
      </div>
    );
  }
