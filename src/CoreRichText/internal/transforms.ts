...
export const moveChildren = (
  editor: PlateEditor,
  options: p.MoveChildrenOptions<Value>,
) => {
...
export const splitNodes = (
  editor: PlateEditor,
  options?: p.SplitNodesOptions<Value>,
) => {
...
export const liftNodes = (
  editor: PlateEditor,
  options?: p.LiftNodesOptions<Value> | undefined,
) => {
...
export const unwrapNodes = (
  editor: PlateEditor,
  options?: p.UnwrapNodesOptions<Value>,
) => {
...
export const deleteText = (
  editor: PlateEditor,
  opts?: Parameters<typeof p.deleteText>["1"],
) => {
...
export const removeNodes = (
  editor: PlateEditor,
  opts?: p.RemoveNodesOptions<Value>,
) => {
