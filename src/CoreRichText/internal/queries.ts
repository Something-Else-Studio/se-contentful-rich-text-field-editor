...
export const getBlockAbove = (
  editor: PlateEditor,
  options?: p.GetAboveNodeOptions<p.Value>,
) => {
...
export const getNodeEntries = (
  editor: PlateEditor,
  options?: p.GetNodeEntriesOptions,
) => {
...
export const isRangeAcrossBlocks = (
  ...
  options?:
    | (Omit<p.GetAboveNodeOptions<p.Value>, "at"> & {
...
export const getAboveNode = (
  editor: PlateEditor,
  opts?: p.GetAboveNodeOptions<Value>,
) => {
...
export const getNextNode = (
  editor: PlateEditor,
  opts?: p.GetNextNodeOptions<Value>,
) => {
...
export const findNode = (
  editor: PlateEditor,
  options?: p.FindNodeOptions<p.Value> | undefined,
) => {
...
export const matchNode = (
  node: Node,
  path: s.Path,
  fn: p.Predicate<PlateEditor | Node>,
) => {
...
export const match = (
  obj: Node,
  path: Path,
  predicate?: p.Predicate<Node> | undefined,
) => {
