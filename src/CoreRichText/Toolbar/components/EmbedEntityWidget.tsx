...
export const EmbedEntityWidget = ({
  isDisabled,
  canInsertBlocks,
}: EmbedEntityWidgetProps) => {
  ...
  const onToggleEntityDropdown = () =>
    setEmbedDropdownOpen(!isEmbedDropdownOpen);

  const inlineEntryEmbedEnabled = isNodeTypeEnabled(
    sdk.field,
    INLINES.EMBEDDED_ENTRY,
  );
  const inlineResourceEmbedEnabled = isNodeTypeEnabled(
    sdk.field,
