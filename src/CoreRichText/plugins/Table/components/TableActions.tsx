  ...
  const action = React.useCallback(
    (
      ...
      () => {
        ...
        editor.tracking.onViewportAction(
          actionName as RichTextTrackingActionName,
          { tableSize },
        );
      },
  ...
  return (
    ...
    >
      ...
      <Menu.List>
        ...
        <Menu.Item onClick={action(addRowBelow, "insert", "Row")}>
          Add row below
        </Menu.Item>
        <Menu.Item onClick={action(addColumnLeft, "insert", "Column")}>
          Add column left
        </Menu.Item>
        <Menu.Item onClick={action(addColumnRight, "insert", "Column")}>
          Add column right
        </Menu.Item>
        <Menu.Divider />
        ...
        <Menu.Divider />
        <Menu.Item onClick={action(deleteRow, "remove", "Row")}>
          Delete row
        </Menu.Item>
        <Menu.Item onClick={action(deleteColumn, "remove", "Column")}>
          Delete column
        </Menu.Item>
        <Menu.Item onClick={action(deleteTable, "remove", "Table")}>
          Delete table
        </Menu.Item>
      </Menu.List>
    </Menu>
