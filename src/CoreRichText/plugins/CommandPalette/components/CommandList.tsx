...
export const CommandList = ({
  ...
  const { selectedItem, isOpen } = useCommandList(
    commandItems,
    popoverContainer,
  );
    ...
    <div className={styles.container} tabIndex={-1} contentEditable={false}>
      ...
      <div role="alert">
        <ScreenReaderOnly>
          ...
          Richtext commands. Currently focused item: {selectedItem}. Press{" "}
          <kbd>enter</kbd> to select, <kbd>arrows</kbd> to navigate,{" "}
