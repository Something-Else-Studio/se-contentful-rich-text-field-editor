...
describe("HTML Sanitization", () => {
  it("removes unsupported elements from <a>", () => {
    const cases = [
      // Supported
      { input: '<h1><a href="#">Link in h1</a></h1>', output: "unchanged" },
      { input: '<div><a href="#">Link in div</a></div>', output: "unchanged" },
      {
        input: '<a href="#"><strong>strong in Link</strong></a>',
        output: "unchanged",
      },
      { input: '<a href="#"><b>b in Link</b></a>', output: "unchanged" },
      { input: '<a href="#"><em>em in Link</em></a>', output: "unchanged" },
      { input: '<a href="#"><i>i in Link</i></a>', output: "unchanged" },
      { input: '<a href="#"><u>u in Link</u></a>', output: "unchanged" },
